...
Route::middleware('admin')->group(function () {
    ...
    // Banner
    Route::controller(PromoBannerController::class)->name('promo.banner.')->prefix('promotion/banner')->group(function () {
    ...
    // Product Collection
    Route::controller(ProductCollectionController::class)->name('collection.')->prefix('collection')->group(function () {
        Route::get('all', 'index')->name('index');
    ...
    // Menu builder
    Route::controller(MenuBuilderController::class)->name('menu.builder.')->prefix('menu')->group(function () {
    ...
    // Users Manager
    Route::controller(ManageUsersController::class)->name('users.')->prefix('users')->group(function () {
    ...
    Route::controller(AttributeController::class)->prefix('product-attributes')->name('attribute.')->group(function () {
        //Product Attributes
        ...
        Route::controller(AttributeValueController::class)->prefix('values')->name('values.')->group(function () {
    ...
    // Product Type
    Route::controller(ProductTypeController::class)->prefix('product-types')
        ->name('product.type.')
        ->group(function () {
            Route::get('', 'index')->name('all');
            Route::get('create', 'create')->name('create');
    ...
    Route::prefix('product')->name('products.')->group(function () {
        ...
        Route::controller(ProductReviewController::class)->name('reviews.')->prefix('reviews')->group(function () {
    ...
    //Coupons
    Route::controller(CouponController::class)->prefix('promotion/coupon')->name('coupon.')->group(function () {
    ...
    //Offers
    Route::controller(OfferController::class)->prefix('promotion/offer')->name('offer.')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::get('create', 'create')->name('create');
        Route::get('edit/{id}', 'edit')->name('edit');
        Route::post('save/  {id}', 'save')->name('store');
    ...
    //Shipping Methods
    Route::controller(ShippingMethodController::class)->prefix('shipping-method')->name('shipping.methods.')->group(function () {
        Route::get('/', 'index')->name('all');
        Route::get('create', 'create')->name('create');
        Route::get('edit/{id}', 'edit')->name('edit');
        Route::post('save/{id?}', 'store')->name('store');
    ...
    Route::name('gateway.')->prefix('gateway')->group(function () {
        // Automatic Gateway
        Route::controller(AutomaticGatewayController::class)->prefix('automatic')->name('automatic.')->group(function () {
            Route::get('/', 'index')->name('index');
        ...
        // Manual Methods
        Route::controller(ManualGatewayController::class)->prefix('manual')->name('manual.')->group(function () {
            Route::get('/', 'index')->name('index');
    ...
    Route::name('setting.notification.')->controller(NotificationController::class)->prefix('notification')->group(function () {
        //Template Setting
    ...
    // Plugin
    Route::controller(ExtensionController::class)->prefix('extensions')->name('extensions.')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::post('update/{id}', 'update')->name('update');
        Route::post('status/{id}', 'status')->name('status');
    });
    ...
    //System Information
    Route::controller(SystemController::class)->name('system.')->prefix('system')->group(function () {
