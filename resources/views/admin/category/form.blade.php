...
@push('script')
    ...
    <script>
        (function($) {
            ...
            const formAction = `{{ url('admin/categories/store') }}`;
            ...
            const selectNodeHandler = (e, data) => {
                ...
                deleteChildButton.attr('data-action', `{{ url('admin/categories/delete') }}/${selectedNode.id}`);
                ...
                $.get(`{{ url('admin/categories/category') }}/${selectedNode.id}`).done((response) => {
            ...
            const checkSlug = () => {
                ...
                if (slug) {
                    $.get(`{{ url('admin/categories/check-slug') }}/${selectedNode?.id??0}`, {
                            slug: slug,
                        },
                        function(response) {
                            if (response.status) {
